...
namespace CAEBS_V2
{
    public partial class frmNewStudent : Form
    {
        ...
        public bool toSave, toUpdate , forOldStudent, forNewStudent, forTransferee;
        public int id;
        public int i = 0, x = 0;
        ...
        {                            
            ...
            else if (forNewStudent == true)
            {
                #region THIS FOR NEW STUDENT
                #region Requirements To Pass                      
                Requirements();
                NoRequirements();
                #endregion
            ...
            else if (forTransferee == true)
            {
                #region THIS FOR Transferee
                #region Requirements To Pass                      
                Requirements();
                NoRequirements();
                #endregion
